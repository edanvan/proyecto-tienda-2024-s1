...
public class Producto {
  ...
  public static void guardarProductos() {
    ...
    try (Formatter escritor = new Formatter(rutaArchivo, "UTF-8")) {
      for (Producto producto : productos) {
        ...
        // para cada producto
        escritor.format("%s,%s,%.2f,%.2f,%d%n", producto.getCodigo(), producto.getNombre(), producto.getPrecio(),
  ...
  public static void verProductos() {
    ...
    System.out.printf(formatoEncabezado, "CÓDIGO", "NOMBRE", "PRECIO BASE", "IVA (%)", "PRECIO FINAL", "INVENTARIO");
